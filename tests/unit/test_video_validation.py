...
class TestVideoValidator:
    ...
    def test_validate_basic_with_valid_file(self, video_validator, test_helpers, temp_dir):
    ...
    def test_validate_basic_unreadable_file(self, video_validator, test_helpers, temp_dir):
    ...
    def test_validate_audio_file_invalid_extension(self, video_validator, test_helpers, temp_dir):
    ...
    def test_validate_iphone_compatibility(self, mock_codec_detector, video_validator, test_helpers, temp_dir):
    ...
    def test_validate_transcoding_output(self, mock_subprocess, video_validator, test_helpers, temp_dir):
    ...
    def test_validation_with_suggestions(self, video_validator, test_helpers, temp_dir):
        ...
        if result.suggestions:
            assert any("convert" in suggestion.lower() or "format" in suggestion.lower() 
