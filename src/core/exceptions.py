...
class iPhoneCompatibilityError(VideoProcessingError):
    ...
    def __init__(self, 
        ...
        super().__init__(message, error_code="IPHONE_COMPATIBILITY_ERROR", details=details)
...
class HardwareAccelerationError(AutoCutError):
    ...
    def __init__(self, 
        ...
        super().__init__(message, error_code="HARDWARE_ACCELERATION_ERROR", details=details)
...
def raise_validation_error(message: str, 
                          validation_type: str,
                          file_path: Optional[str] = None,
                          failed_checks: Optional[List[str]] = None) -> None:
...
def raise_iphone_error(message: str,
                      file_path: str,
                      platform: Optional[str] = None,
...
def raise_transcoding_error(message: str,
                           input_file: str,
                           ffmpeg_command: Optional[str] = None,
