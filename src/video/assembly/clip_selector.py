...
class ClipSelector:
    ...
    def _apply_selection_strategy(self,
        ...
        elif strategy == SelectionStrategy.VARIETY_FOCUSED:
        ...
        elif strategy == SelectionStrategy.DURATION_OPTIMIZED:
        ...
        for selected_clip in selected:
            ...
            if (overlap_duration > 0 or gap < self.criteria.min_gap_between_clips):
                if resolution == OverlapResolution.SKIP_OVERLAPPING:
                    return True
                elif resolution == OverlapResolution.PREFER_HIGHER_QUALITY:
                    return candidate.score <= selected_clip.score
                elif resolution == OverlapResolution.PREFER_EARLIER:
