    ...
    def prepare_encoding_parameters(self, target_format: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if memory_percent > 80.0:
                print(f"High memory ({memory_percent:.1f}%) - reducing encoding quality for stability")
                ...
                if "bitrate" in moviepy_params:
                    ...
                    if current_bitrate.endswith("k"):
                        ...
                        print(f"Reduced bitrate: {current_bitrate} → {moviepy_params['bitrate']}")
                
        except Exception as e:
            print(f"Failed to check memory for quality adjustment: {e}")
        ...
        print(f"Mac-compatible encoding parameters prepared with enhanced AAC audio")
        return write_params
    ...
    def encode_video(
        ...
        try:
            ...
            if not self.compatibility_info:
                ...
                print(f"MoviePy API compatibility: {self.compatibility_info['version_detected']}")
            ...
            try:
                ...
                print("Lowered encoding process priority to prevent system lockup")
            except:
                pass
            ...
            print(f"✅ Video encoding completed successfully in {encoding_time:.1f}s")
            return output_path
