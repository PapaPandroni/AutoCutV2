...
class CodecDetector:
    ...
    def detect_video_codec(self, file_path: str, use_cache: bool = True) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            codec_info = {
                ...
                'has_audio': len([s for s in data.get('streams', []) 
    ...
    def _calculate_compatibility_score(self, codec: str, container: str, format_name: str, 
    ...
    def get_iphone_compatibility_info(self, file_path: str) -> Dict[str, Any]:
        ...
        if iphone_info['compatibility_issues'] and not iphone_info['requires_transcoding']:
            iphone_info['is_iphone_compatible'] = False
