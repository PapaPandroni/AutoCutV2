...
class AutoCutAPI:
    ...
    def validate_video(self, 
                      video_path: str, 
                      detailed: bool = False) -> ValidationResult:
        """
    ...
    def run_diagnostics(self) -> DiagnosticReport:
        ...
        try:
            ...
            recommendations.append("Install FFmpeg: apt install ffmpeg (Ubuntu) or brew install ffmpeg (macOS)")
        ...
        if not system_info.has_hardware_acceleration:
            recommendations.append("Consider enabling hardware acceleration for faster processing")
        ...
        if not os.path.exists('test_media'):
            ...
            recommendations.append("Create test_media/ directory with sample video/audio files for testing")
    ...
    def run_demo(self, 
                quick: bool = False, 
                pattern: str = 'balanced',
                test_media_dir: str = 'test_media') -> DemoResult:
        """
