...
class HardwareDetector:
    ...
    def detect_optimal_settings(self, force_cpu: bool = False) -> Dict[str, Any]:
        ...
        if (not force_cpu and
            self._hardware_cache is not None and 
        ...
        default_result = {
            'moviepy_params': {'codec': 'libx264', 'audio_codec': 'aac', 'threads': os.cpu_count() or 4},
    ...
    def _test_hardware_encoder(self, 
                             encoder_name: str, 
                             encoder_codec: str, 
        ...
        try:
            ...
            combined_cmd = [
                'ffmpeg', '-y', '-f', 'lavfi', 
                '-i', 'testsrc2=duration=0.5:size=160x120:rate=5',  # Small/fast test
                '-c:v', encoder_codec,
            ...
            format_valid = self._validate_encoder_output_fast(temp_output, expected_profile='Main')
    ...
    def _validate_encoder_output_fast(self, 
                                    video_path: str, 
                                    expected_profile: str = 'Main') -> bool:
        """
    ...
    def test_specific_encoder(self, encoder_name: str, encoder_codec: str) -> Dict[str, Any]:
        """
...
def detect_optimal_codec_settings_enhanced() -> Tuple[Dict[str, Any], List[str], Dict[str, str]]:
    ...
    return (
        result['moviepy_params'], 
        result['ffmpeg_params'], 
        result['diagnostics']
    )
